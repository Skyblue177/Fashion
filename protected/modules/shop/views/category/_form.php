                        ...
                        <div class="cool-block-bor">
							<div class="form-horizontal" role="form">
								...
								<div class="form-group">
									...
									<?php echo $form->textField($model,'title',array('class'=>'form-control','placeholder'=>'Danh mục...')); ?>
									<?php echo $form->error($model,'title'); ?>
								</div>

								<div class="form-group">
									<?php echo $form->labelEx($model,'language',array('class'=>'col-lg-3 control-label')); ?>
									<?php echo $form->textField($model,'language',array('class'=>'form-control','placeholder'=>'Ngôn ngữ...')); ?>
								...
								<div class="form-group">
									<div class="col-lg-offset-2 col-lg-10">
										<?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('ShopModule.shop', 'Create') : Yii::t('ShopModule.shop', 'Save'),array('class'=>'btn btn-info')); ?>
									</div>
								</div>
